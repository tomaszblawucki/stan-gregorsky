...
edit_comment = views.EventsViewSet.as_view({'post':'edit_comment'})
destroy_comment = views.EventsViewSet.as_view({'get':'destroy_comment'})
list_idea_comments = views.EventsViewSet.as_view({'get':'list_idea_comments'})
...
urlpatterns = [
    ...
    path('ideas/<int:pk>/add-comment/', add_comment, name='add_comment'),
    path('ideas/edit-comment/<int:pk>/', edit_comment, name='edit_comment'),
    path('ideas/<int:pk>/list-comments/', list_idea_comments, name='list_comments'),
    path('ideas/destroy-comment/<int:pk>', destroy_comment, name='destroy_comment'),
