    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('INIT', 'Initialized'), ('RUNNING', 'In progress'), ('CLOSED', 'Closed')], default='Initialized', max_length=15)),
                ('type', models.CharField(choices=[('BST', 'Brainstorm')], default='Brainstorm', max_length=15)),
